    ...
    public function save()
    {
        ...
        $sql = "INSERT INTO tb_users
            SET user_email=:user_email, user_password=:user_password, user_nama=:user_nama, 
                user_alamat=:user_alamat, user_hp=:user_hp, user_pos=:user_pos, 
                user_role=:user_role, user_aktif=:user_aktif";
    ...
    public function update()
{
    ...
    $user_alamat = isset($_POST['user_alamat']) ? $_POST['user_alamat'] : '';
    $user_hp = isset($_POST['user_hp']) ? $_POST['user_hp'] : '';
    $user_pos = isset($_POST['user_pos']) ? $_POST['user_pos'] : '';
    $user_role = isset($_POST['user_role']) ? $_POST['user_role'] : '';
    $user_aktif = isset($_POST['user_aktif']) ? $_POST['user_aktif'] : '';
    ...
    // Conditionally bind password parameter
    if (!empty($user_password)) {

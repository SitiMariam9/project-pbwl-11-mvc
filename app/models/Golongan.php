...
{
    // Hapus data yang terkait di tb_pelanggan terlebih dahulu
    $this->deletePelangganByGolongan($gol_id);

    // Hapus data dari tb_golongan
...
private function deletePelangganByGolongan($gol_id)
{
    $sql = "DELETE FROM tb_pelanggan WHERE pel_id_gol=:gol_id";
    $stmt = $this->db->prepare($sql);
